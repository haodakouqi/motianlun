...
import { BillChannelListPage, BillChannelCountPage, BillChannelTrendPage } from "@/api/bill";
...
function usetable() {
    ...
    const getList = async() => {
      try {
        ...
        const res = await BillChannelListPage(params);
  ...
  setup(props, ctx) {
    ...
    const getTotalCount = async () => {
      try {
        ...
        const res = await BillChannelCountPage(params);
        const a = (res.data || [])
    ...
    const getChartData = async () => {
      try {
        ...
        const res = await BillChannelTrendPage(params);
        const a= (res.data || {})

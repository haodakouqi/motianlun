...
import { BillAccountListPage, BillAccountCountPage, BillAccountTrendPage } from "@/api/bill";
...
function usetable() {
    ...
    const getList = async() => {
      try {
        ...
        const res = await BillAccountListPage(params);
  ...
  setup(props, ctx) {
    ...
    const getTotalCount = async () => {
      try {
        ...
        const res = await BillAccountCountPage(params);
        const a = (res.data || [])
    ...
    const getChartData = async () => {
      try {
        ...
        const res = await BillAccountTrendPage(params);
        const a = (res.data || {})

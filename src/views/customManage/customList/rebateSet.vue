  ...
  <div>
    ...
    >
      ...
      >
        ...
        >
          <el-input
            v-model.trim="formData.serviceChargeRate"
...
import { saveCustomerRebate, updateCustomerRebate } from "@/api/custom";
const resetFormData = () => {
  return {
    platform: "",
    startMonth: "",
  ...
  setup(props, ctx) {
    ...
    const submitForm = async (formEl: FormInstance | undefined) => {
      try {
        ...
        if (isEdit.value) {
          await updateCustomerRebate(formData); 
        } else {
          await saveCustomerRebate(formData);
        }

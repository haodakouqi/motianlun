...
window.calendar = (function() {
    ...
    var N = (function() {
        ...
        function C() {
            var Z = Q.getJson();
            var c = Z.dateArray;
            M("cm").style.height = (Z.lines * 40 + 2)/100 + "rem";
            M("cm").innerHTML = "";
            for (var a = 0; a < c.length; a++) {
                ...
                if (c[a].isToday) {
                    //选中cell的背景色和边框颜色
                    X.style.cssText="background:#cde9d9;border-radius:50%;padding:0.05rem 0;"
                }
                X.className = "cell";
                X.style.left = ((a % 7) * 60)/100 + "rem";
                X.style.top = (Math.floor(a / 7) * 40 + 2)/100 + "rem";
                var b = R("DIV");
                b.className = "so";
    ...
    var F = (function() {
        ...
        function G(b) {
            ...
            C.innerHTML = Y(c, a);
            C.style.top = (Z.offsetTop + Z.offsetHeight - 45)/100 + "rem";
            C.style.left = (Z.offsetLeft + Z.offsetWidth + 10)/100 + "rem";

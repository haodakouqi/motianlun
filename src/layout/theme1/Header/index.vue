  ...
  <header>
    ...
    <div class="right-box">
      ...
      <div class="function-list">
        <div class="function-list-item hidden-sm-and-down"><help /></div>
      ...
      <PasswordLayer ref="PasswordLayer"  />
    </div>
  </header>
</template>
...
import help from '../../components/functionList/help.vue'
...
export default defineComponent({
  ...
  setup() {
    ...
    const PasswordLayer: Ref<any> = ref(null)
    ...
    const showPasswordLayer = () => {
      PasswordLayer.value.visible = true
    }
    return {
      userInfo,
      isCollapse,
